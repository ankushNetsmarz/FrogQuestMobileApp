...
// in simulator we redefine to format for FrogQuest Developer console
...
{\
	NSString * exceptionName = [@"org.frogquest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.frogquest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFrogQuestNativeItemNone = -1, 
	UIFrogQuestNativeItemSpinner = -2,
	UIFrogQuestNativeItemProgressBar = -3,
	
	UIFrogQuestNativeItemSlider = -4,
	UIFrogQuestNativeItemSwitch = -5,
	UIFrogQuestNativeItemMultiButton = -6,
	UIFrogQuestNativeItemSegmented = -7,
	
	UIFrogQuestNativeItemTextView = -8,
	UIFrogQuestNativeItemTextField = -9,
	UIFrogQuestNativeItemSearchBar = -10,
	
	UIFrogQuestNativeItemPicker = -11,
	UIFrogQuestNativeItemDatePicker = -12,
	
	UIFrogQuestNativeItemInfoLight = -13,
	UIFrogQuestNativeItemInfoDark = -14,
	
	UIFrogQuestNativeItemDisclosure = -15,
	
	UIFrogQuestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FrogQuest instances of

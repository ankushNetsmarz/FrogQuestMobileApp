...
//@interface FrogQuestObject : NSObject
//@end

@interface FrogQuestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FrogQuestObject class]])
		{
			for (NSString *key in [[(FrogQuestObject*)o modules] allKeys])
			{

...
/**
 Base class for all FrogQuest views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the FrogQuest view hierarchy (such as wrapped iOS UIViews) was touched.

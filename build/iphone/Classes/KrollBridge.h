...
@interface FrogQuestObject : KrollCoverageObject {
#else
@interface FrogQuestObject : KrollObject {
#endif
@private
...
extern NSString * FrogQuest$ModuleRequireFormat;
